...
class PatchedHazardEvaluation(BaseModel):
    """
    PatchedHazardEvaluation
    """ # noqa: E501
    id: Optional[StrictInt] = None
    observations: Optional[List[NestedObservation]] = None
    examination_type: Optional[ExaminationType] = None
    examination_type_id: Optional[StrictInt] = None
    ...
    actions: Optional[List[StrictInt]] = None
    hse_specialist: Optional[StrictStr] = None
    employment_history_id: Optional[StrictInt] = None
    employment_history: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "observations", "examination_type", "examination_type_id", "person_id", "physician_id", "physician", "note", "interpretation", "performed_at", "created_at", "updated_at", "actions", "hse_specialist", "employment_history_id", "employment_history"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hse_specialist": obj.get("hse_specialist"),
            "employment_history_id": obj.get("employment_history_id"),
            "employment_history": obj.get("employment_history")
        })
        return _obj
