...
class CallbackTokenVerification(BaseModel):
    """
    ...
    mobile: Optional[Annotated[str, Field(strict=True, max_length=17)]] = None
    token: Annotated[str, Field(min_length=6, strict=True, max_length=6)]
    __properties: ClassVar[List[str]] = ["email", "mobile", "token"]
