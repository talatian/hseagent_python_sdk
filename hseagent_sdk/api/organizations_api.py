...
class OrganizationsApi:
    ...
    def organizations_destroy(
        self,
        id: Annotated[StrictInt, Field(description="A unique integer value identifying this سازمان.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: A unique integer value identifying this سازمان. (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def organizations_partial_update(
        self,
        id: Annotated[StrictInt, Field(description="A unique integer value identifying this سازمان.")],
        patched_organization: Optional[PatchedOrganization] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: A unique integer value identifying this سازمان. (required)
        :type id: int
        :param patched_organization:
        :type patched_organization: PatchedOrganization
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._organizations_partial_update_serialize(
            id=id,
            patched_organization=patched_organization,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _organizations_partial_update_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if patched_organization is not None:
            _body_params = patched_organization
