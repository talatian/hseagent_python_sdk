...
class RolesApi:
    ...
    def roles_destroy(
        self,
        id: Annotated[StrictInt, Field(description="A unique integer value identifying this سمت.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: A unique integer value identifying this سمت. (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._roles_destroy_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def roles_destroy_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="A unique integer value identifying this سمت.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def roles_destroy_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="A unique integer value identifying this سمت.")],
        _request_timeout: Union[
            None,
    ...
    def roles_partial_update(
        self,
        id: Annotated[StrictInt, Field(description="A unique integer value identifying this سمت.")],
        patched_role: Optional[PatchedRole] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._roles_partial_update_serialize(
            id=id,
    ...
    @validate_call
    def roles_partial_update_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="A unique integer value identifying this سمت.")],
        patched_role: Optional[PatchedRole] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def roles_partial_update_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="A unique integer value identifying this سمت.")],
        patched_role: Optional[PatchedRole] = None,
        _request_timeout: Union[
    ...
    def _roles_partial_update_serialize(
        self,
        id,
        patched_role,
        _request_auth,
