...
class Action(BaseModel):
    ...
    created_at: datetime
    updated_at: datetime
    __properties: ClassVar[List[str]] = ["id", "action_type", "person", "based_on_examination", "based_on_report", "data", "result", "based_on_examination_id", "based_on_report_id", "status", "created_at", "updated_at"]
