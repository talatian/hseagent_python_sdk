...
class PatchedHSEReport(BaseModel):
    """
    PatchedHSEReport
    """ # noqa: E501
    ...
    examinations: Optional[List[Examination]] = None
    reason: Optional[StrictStr] = None
    final_opinion: Optional[FinalOpinionEnum] = None
    recommendations: Optional[StrictStr] = None
    status: Optional[HSEReportStatusEnum] = None
    report_file: Optional[StrictStr] = None
    examination_ids: Optional[List[StrictInt]] = None
    status_fa: Optional[StrictStr] = None
