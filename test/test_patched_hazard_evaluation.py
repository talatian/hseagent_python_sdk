...
class TestPatchedHazardEvaluation(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PatchedHazardEvaluation:
        """Test PatchedHazardEvaluation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchedHazardEvaluation`
        """
        model = PatchedHazardEvaluation()
        if include_optional:
    ...
    def testPatchedHazardEvaluation(self):
        """Test PatchedHazardEvaluation"""
