...
class TestPatchedExamination(unittest.TestCase):
    """PatchedExamination unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchedExamination:
        """Test PatchedExamination
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchedExamination`
        """
        model = PatchedExamination()
        if include_optional:
            return PatchedExamination(
                id = 56,
                observations = [
    ...
    def testPatchedExamination(self):
        """Test PatchedExamination"""
